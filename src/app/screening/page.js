...
const questions = [
  {
    id: 1,
    section: "Aspek Kesehatan Fisik",
    text: "Memiliki penyakit kronis (DM, hipertensi)",
  },
  { id: 2, section: "Aspek Kesehatan Fisik", text: "Rutin minum obat" },
  {
    id: 3,
    section: "Aspek Kesehatan Fisik",
    text: "Mengalami kelelahan saat beraktivitas",
  },
  ...
  {
    id: 8,
    section: "Aspek Seksualitas Lansia",
    text: "Mengalami penurunan gairah seksual",
  },
  {
    id: 9,
    section: "Aspek Seksualitas Lansia",
    text: "Kesulitan dalam hubungan seksual",
  },
  {
    id: 10,
    section: "Aspek Seksualitas Lansia",
    text: "Merasa malu membahas seksualitas",
  },
  {
    id: 11,
    section: "Aspek Seksualitas Lansia",
    text: "Komunikasi seksual dengan pasangan kurang",
  },
  {
    id: 12,
    section: "Aspek Seksualitas Lansia",
    text: "Tidak puas dalam hubungan seksual",
  },
];
...
const interventions = [
  {
    ...
    description:
      "Meningkatkan kesejahteraan emosional melalui penguatan kenangan positif.",
  ...
  },
  {
    ...
    description:
      "Latihan otot panggul untuk kontrol kandung kemih dan vitalitas fisik.",
  ...
  },
  {
    ...
    description:
      "Meningkatkan keintiman melalui dialog terpandu dan pengertian mendalam.",
  ...
  },
  {
    ...
    description:
      "Sentuhan terapeutik untuk relaksasi maksimal dan kenyamanan psikologis.",
...
export default function ScreeningPage() {
        ...
        <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl border border-neutral-200 p-10 md:p-14">
          <div className="flex justify-center mb-8">
            <div className="relative">
              ...
              <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-amber-500 rounded-lg flex items-center justify-center border-4 border-white">
                <ShieldCheck className="w-4 h-4 text-white" />
              </div>
            </div>
          </div>

          <h1 className="text-3xl font-black text-amber-950 mb-6 text-center tracking-tighter uppercase">
            Informed Consent
          </h1>

          <div className="space-y-4 text-neutral-600 text-sm leading-relaxed mb-10 text-justify">
            <p>
              Instrumen <strong>ASKAS LANSIA</strong> (Asesmen Kesehatan Kasus
              Lansia) dirancang untuk memberikan deteksi dini terhadap risiko
              kesehatan fisik, psikologis, dan fungsional.
            </p>
            <p className="p-4 bg-neutral-50 rounded-xl border-l-4 border-red-600 font-medium italic">
              "Kami menjamin kerahasiaan penuh atas data pribadi dan jawaban
              Anda. Seluruh informasi yang dikumpulkan hanya akan digunakan
              untuk kepentingan analisis kesehatan dan edukasi medis secara
              internal."
            </p>
            <ul className="list-disc pl-5 space-y-2">
              <li>
                Data tidak akan pernah dibagikan kepada pihak ketiga atau
                platform iklan mana pun.
              </li>
              <li>
                Partisipasi Anda bersifat sukarela dan Anda dapat menghentikan
                pengisian kapan saja.
              </li>
              <li>
                Hasil skrining bersifat informatif dan bukan merupakan pengganti
                diagnosis medis final dari dokter.
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <button
              ...
              className="w-full py-5 bg-amber-600 text-white rounded-2xl font-bold hover:bg-amber-700 transition-colors flex items-center justify-center gap-3"
            >
              Setuju & Lanjutkan <ArrowRight className="w-5 h-5 text-white" />
            </button>
            <Link
              href="/"
      ...
      <div className="min-h-screen bg-neutral-50 py-16 px-6">
        <div className="max-w-lg mx-auto bg-white rounded-3xl shadow-xl border border-neutral-100 p-12">
          <div className="flex items-center gap-4 mb-10">
            <div className="p-3 bg-amber-600 rounded-2xl shadow-lg shadow-amber-500/50 transition-shadow">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-neutral-50 border border-neutral-200 rounded-2xl px-5 py-4 focus:border-red-600 outline-none transition-all font-medium text-sm"
                onChange={(e) =>
                  setIdentity({ ...identity, tinggal: e.target.value })
                }
              />
            </div>
          </div>
          ...
          <button
            ...
            className="w-full mt-12 py-5 bg-amber-600 text-white rounded-2xl font-bold 
             hover:bg-amber-700 disabled:bg-amber-100 disabled:text-amber-300 
  ...
  if (step === "questions") {
    return (
      <div className="min-h-screen bg-orange-50/50 py-12 px-6">
        <div className="max-w-2xl mx-auto">
          {/* Header Progress */}
          <div className="flex justify-between items-end mb-8 px-2">
            <div>
              <h1 className="text-2xl font-black text-amber-950 tracking-tighter uppercase">
                Instrumen ASKAS
              </h1>
            ...
            {sections.map((sectionTitle) => (
              <div key={sectionTitle} className="relative">
                ...
                <div className="flex items-center gap-4 mb-6">
                  <h2 className="text-xs font-black uppercase tracking-[0.2em] text-amber-950 bg-white px-4 py-2 border border-amber-100 rounded-lg shadow-sm whitespace-nowrap">
                    {sectionTitle}
                  </h2>
                ...
                <div className="space-y-6">
                  {questions
                    ...
                    .map((q) => (
                      <div
                        key={q.id}
                        className="bg-white rounded-2xl p-8 border border-amber-50 shadow-sm transition-all hover:border-amber-200"
                      >
                        <p className="text-amber-900 font-bold mb-6 leading-relaxed tracking-tight text-lg">
                          {q.text}
                        </p>
                        <div className="flex gap-4">
                          {["ya", "tidak"].map((opt) => (
                            <button
                              ...
                              className={`flex-1 py-4 rounded-xl text-[10px] font-black border transition-colors uppercase tracking-[0.2em]
                            ${
                              answers[q.id] === opt
                                ? "bg-amber-600 border-amber-600 text-white shadow-md"
                                : "bg-white border-amber-100 text-amber-400 hover:border-amber-300 hover:text-amber-600"
                            }`}
                            >
                              {opt}
                            </button>
          ...
          <button
            ...
            className={`w-full mt-16 py-6 rounded-2xl font-black text-white transition-colors uppercase tracking-widest text-sm
          ${
            Object.keys(answers).length === questions.length
              ? "bg-amber-600 hover:bg-amber-700 shadow-lg shadow-amber-900/10"
              : "bg-amber-50 text-amber-200 cursor-not-allowed"
          }`}
          >
  ...
  return (
    <div className="min-h-screen bg-neutral-50 py-16 px-6">
      <div className="max-w-lg mx-auto space-y-6">
        {/* ── Result Card ── */}
        <div
          className={`bg-white rounded-[2.5rem] shadow-2xl p-12 border border-neutral-100 text-center relative`}
        >
          ...
          <div className="mt-6 mb-6">
            ...
            <h2
              className={`text-5xl font-black mb-4 tracking-tighter ${result.color}`}
            >
              {result.label}
            </h2>
            <div
          ...
          <p className="text-neutral-500 mb-10 leading-relaxed font-medium italic text-sm">
            "{result.desc}"
          </p>
